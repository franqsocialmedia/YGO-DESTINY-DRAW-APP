...
const ContentManager = {
    ...
    CATALOG: [
        ...
        { id: 'cv-lore',         group: 'Vista de Carta', label: 'Lore de la Carta (Yugipedia)', novato: false, casual: false, competitivo: true },
        ...
        { id: 'sim-counters',         group: 'Simuladores', label: 'Counters (CounterSim)',              novato: false, casual: false, competitivo: true },
        ...
        { id: 'form-juegos',    group: 'Formación', type: 'tab', label: 'Juegos',            novato: true,  casual: true,  competitivo: true },
        ...
        { id: 'config-test-duelo',         group: 'Configuración', label: 'Test de Duelo',               novato: true,  casual: true,  competitivo: true },
